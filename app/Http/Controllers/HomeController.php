...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // Hitung kategori berdasarkan kolom category
        $categoryLabels = ['Kecil', 'Menengah', 'Besar'];
        $categoryData = [];

        foreach ($categoryLabels as $label) {
            $categoryData[] = User::role('member')->where('category', $label)->count();
        }

        $categoryChart = new Chart;
        $categoryChart->labels($categoryLabels);
        $categoryChart->dataset('Kategori', 'doughnut', $categoryData)
    ...
    public function getCategoryCount(Request $request)
    {
        ...
        if ($category === 'all') {
            ...
            $count = User::role('member')->where('category', $category)->count();
        }
