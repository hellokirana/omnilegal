...
class MemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['category'] = $this->getCategoryFromPrintingLineTotal($request->printing_line_total);
    ...
    public function update(Request $request, $id)
    {
        $validated = Validator::make($request->all(), [
            ...
            'process_printing' => ['nullable', 'array'],
            'process_printing.*' => ['string', 'max:255'],
        ...
        // Tentukan category berdasarkan printing_line_total
        $category = $this->getCategoryFromPrintingLineTotal($request->printing_line_total);
        ...
        $data->update([
            ...
            'process_printing' => implode(', ', $request->process_printing ?? []),
    ...
    /**
     * Get category based on printing_line_total
     * 
     * @param string $printingLineTotal
     * @return string
     */
    private function getCategoryFromPrintingLineTotal($printingLineTotal)
    {
