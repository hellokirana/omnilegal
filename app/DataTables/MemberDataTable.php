...
class MemberDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('category', function ($model) {
                // Add a category display formatter with color-coding
                if ($model->category === 'kecil') {
                    return 'Kecil';
                } elseif ($model->category === 'menengah') {
                    return 'Menengah';
                } elseif ($model->category === 'besar') {
                    return 'Besar';
                }
                return '-';
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('category')->title('Kategori')->searchable(true)->orderable(true),
            ...
            Column::make('contact_name')->title('Nama Kontak'),
            Column::make('contact_phone')->title('No Telp Kontak'),
            Column::make('contact_department')->title('Departemen Kontak'),
            Column::make('contact_position')->title('Posisi Kontak'),
            Column::make('contact_email')->title('Email Kontak'),
