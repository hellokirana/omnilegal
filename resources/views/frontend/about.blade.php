    ...
    <div class="container">
        <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
            <div class="row align-items-center justify-content-center">
                {{-- Logo --}}
                <div class="col-md-3 text-center mb-3 mb-md-0" data-aos="fade-up" data-aos-delay="200">
...
{{-- Team Section --}}
<section id="about-team" class="team-section py-5 bg-white">
    <div class="container">
        ...
        <div class="team-container">
            @foreach($teams as $index => $team)
                <div class="team-card-horizontal shadow-sm border-0 rounded-3 overflow-hidden mb-4" 
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-12 col-md-8 col-lg-9">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <div class="team-description" data-aos="fade-up" data-aos-delay="150">
...
{{-- Disclaimer Section --}}
<section class="py-8 bg-light" data-aos="fade-up">
    <div class="container">
