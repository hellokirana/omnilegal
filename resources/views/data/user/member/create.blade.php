                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('member.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="total_employee" id="total_employee" class="form-control" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="printing_line_total" id="printing_line_total" class="form-control" >
                        ...
                        <div class="row mb-3"> 
                            <label for="process_printing" class="col-md-4 col-form-label text-md-end">Process Printing</label> 
                            <div class="col-md-6"> @foreach($process_printing as $value) 
                                <div class="form-check"> <input class="form-check-input" type="checkbox" name="process_printing[]" value="{{ $value }}" id="process_printing_{{ $loop->index }}"> 
                                    <label class="form-check-label" for="process_printing_{{ $loop->index }}"> 
                                        {{ $value }} 
                                    </label> 
                                </div> 
                            @endforeach 
