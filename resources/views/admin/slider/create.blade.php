                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <x-form.textarea label="Deskripsi (ID)" for="description_id" name="description_id"
                                    value="{{ old('description_id') }}" :error="$errors->first('description_id')" rows="3" />
                            </div>
                            <!-- Description EN -->
                            <div class="col-md-6 mb-3">
                                <x-form.textarea label="Description (EN)" for="description_en" name="description_en"
                                    value="{{ old('description_en') }}" :error="$errors->first('description_en')" rows="3" />
                            </div>

                            <!-- Link -->
                            <div class="col-md-6 mb-3">
                                <x-form.text label="Link" for="link" name="link"
                                    value="{{ old('link') }}" :error="$errors->first('link')" />
                            </div>
                            <!-- Link Caption ID -->
                            <div class="col-md-3 mb-3">
                                <x-form.text label="Caption (ID)" for="link_caption_id" name="link_caption_id"
                                    value="{{ old('link_caption_id') }}" :error="$errors->first('link_caption_id')" />
                            </div>
                            <!-- Link Caption EN -->
                            <div class="col-md-3 mb-3">
                                <x-form.text label="Caption (EN)" for="link_caption_en" name="link_caption_en"
                                    value="{{ old('link_caption_en') }}" :error="$errors->first('link_caption_en')" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <x-form.number label="Queue" for="queue" name="queue"
                                value="{{ old('queue') }}" min="1" :error="$errors->first('queue')" required />
                        </div>
