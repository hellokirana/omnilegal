(function ($) {
    ...
    if ($(".single-item-carousel").length) {
        var totalSlides = $(".single-item-carousel .swiper-slide").length;

        var singleItemCarousel = new Swiper(".single-item-carousel", {
            preloadImages: false,
            loop: totalSlides > 1, // aktifkan loop hanya kalau lebih dari 1
            centeredSlides: false,
            resistance: true,
            resistanceRatio: 0.6,
            speed: 1400,
            ...
            autoplay:
                totalSlides > 1
                    ...
                    : false, // autoplay mati kalau cuma 1 slide
            navigation: {
                nextEl: ".swiper-button-next",
                prevEl: ".swiper-button-prev",
            },
